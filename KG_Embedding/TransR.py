...
#import the data and transform to the required format
...
df.to_csv('KnowledgeGraph_Embedding/TransR_Triples.csv', index=False)


# Metric results
metric_results = result.metric_results.to_df()
metric_results.to_csv('KnowledgeGraph_Embedding/TransR_Metrics.csv')
